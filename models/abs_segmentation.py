...
from Plot2Spec_materials_eyes.src.plot_data_extraction.utils import Segmap2Lines, GenerateTestData, dict2class
...
#             #print(np.var(y))
#             # plt.show()
#             return wavelength, f(wavelength) # np.array([wavelength, y])
...
def get_abs_dictionary(path, abs_image):
    ...
    for file in os.listdir(path):
      shutil.copy(f'{path}/{file}',
                'Plot2Spec_materials_eyes/data/input_plot_extraction/leftImg8bit/test/abs_spectra/')
