...
in_house_data = pd.read_csv(
    'C:/Users/kvriz/Desktop/Polybot_ECPs/datasets/closeloop_all_past_experiments_new.csv'
)

# lab_values = list(zip(in_house_data['L'], in_house_data['a'], in_house_data['b']))

lab_values = list(
    zip(in_house_data['L_exp'], in_house_data['a_exp'], in_house_data['b_exp'])
)
